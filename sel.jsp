...
<html>
    <head>
        ...
        <link href="sel.css?ver=13" rel="stylesheet">
    </head>
    <body>
        <div class="bb">
            <div class="modalsel_1" id="modla">
                <div class="modalcon">
                    <div class="modalhead">
                        <h4 class="mo_title">지금 당장 떠나고 싶은 일본 여행지 월드컵 16강</h4>
                    </div>
                    <form action="play1.jsp" method="get">
                        <div class="modalbody">
                        ...
                        <div class="modalfoot">
                            <button type="submit" class="mf_btn cs1" onClick="location.href='play1.jsp'" style="font-family:서울한강체">시작하기</button>    
